    ...
    <React.Fragment>
              ...
              <Grid container spacing={2} justify="center">
                <Grid item>
                  <Button
                    variant="contained"
                    color="primary"
                    href="https://github.com/HyeonHak?tab=repositories"
                  >
                ...
                <Grid item>
                  <Button
                    variant="outlined"
                    color="primary"
                    href="https://blog.naver.com/zhh102000"
                  >
          ...
          <Grid container spacing={4}>
              ...
              <Card className={classes.card}>
                ...
                <CardActions>
                  <Button
                    size="small"
                    color="primary"
                    href="https://youtu.be/izKCOyBcSOE"
                  >
                    View
                  </Button>
                  <Button
            ...
            <Grid item key={4} xs={12} sm={6} md={4}>
              <Card className={classes.card}>
                <CardMedia
                  className={classes.cardMedia}
                  image={require("../static/images/project2.JPG")}
                  title="Image title"
                />
                <CardContent className={classes.cardContent}>
                  <Typography gutterBottom variant="h5" component="h2">
            ...
            <Grid item key={4} xs={12} sm={6} md={4}>
              <Card className={classes.card}>
                <CardMedia
                  className={classes.cardMedia}
                  image={require("../static/images/project3.JPG")}
                  title="Image title"
                />
                <CardContent className={classes.cardContent}>
                  <Typography gutterBottom variant="h5" component="h2">
      ...
      <footer className={classes.footer}>
        ...
        <Typography
          ...
          component="p"
        >
          1994년 1월 26일 출생 {<br />} 서경대학교 컴퓨터 공학과 졸업 - 학점 :
          3.59 / 4.5 (2019)
          {<br />}
